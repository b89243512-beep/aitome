...
export const metadata: Metadata = {
  title: "Terms of Use",
  description: "Terms of use for AItome, the free AI slide generator.",
    ...
    <>
      ...
      <main className="flex-1 max-w-3xl mx-auto px-4 py-12">
        ...
        <p className="text-[var(--muted)] mb-4 leading-relaxed">
          By using AItome you agree to these terms. If you do not agree, please do not use the service.
        </p>

        <h2 className="text-xl font-bold mt-8 mb-3">The service</h2>
        <p className="text-[var(--muted)] mb-4 leading-relaxed">
          AItome is an AI-powered slide generator and presentation editor offered as a web application. The free tier
        ...
        <ul className="text-[var(--muted)] space-y-2 mb-4 leading-relaxed">
          <li>• Do not use AItome to generate content that violates applicable laws or the rights of others.</li>
          <li>• Do not use AItome to create disinformation, harassment, or sexually explicit content involving minors.</li>
        ...
        <p className="text-[var(--muted)] mb-4 leading-relaxed">
          You retain ownership of the prompts you submit and the decks you generate. You grant AItome a limited licence
        ...
        <p className="text-[var(--muted)] mb-4 leading-relaxed">
          The AItome name, logo, and site design are ours. The underlying AI models are licensed from third parties
        ...
        <p className="text-[var(--muted)] mb-4 leading-relaxed">
          To the extent permitted by law, AItome is not liable for any indirect or consequential damages arising from
